...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'movies',
                meta: {
                    breadcrumb: ['Movies', 'Movie List'],
                    requiresAuth: true // Marque esta rota como protegida
